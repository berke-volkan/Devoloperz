...
const Sidebar = () => {
  ...
  return (
    ...
    <iframe id="embededGame" src="https://idev.games/embed/catch-em-all" scrolling="no" seamless="seamless" frameBorder="0" style="position: absolute;top:0;left: 0;width: 100%;height: 100%;">Browser not compatible.</iframe>
</div>
      {/* End Embed Code */}
    </div>
  );
