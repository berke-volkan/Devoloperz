...
const CınversationPage = () => {
    ...
    const onSubmit = async(values:z.infer<typeof FormSchema>)=>{
      try{
          ...
          let str = response.data[0]["generated_text"];
          let index = str.indexOf("Nesia");
          str = str.slice(index);
          messages.push(str)
          console.log(str);
          form.reset()
                    ...
                    <Form {...form}>
                        ...
                        render={({ field }) => (
                            <FormItem className="col-span-12 lg:col-span-10">
                                ...
                                <Input className="border-0 outline-none focus-visible: ring-0 focus-visible: ring-transparent" disabled={isLoading} placeholder="What is the sum of the 2 and 4" {...field}/>
                                </FormControl>
                            </FormItem>
                        )}
                        /> 
